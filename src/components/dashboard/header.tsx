...
import { Search, PhoneCall, Crown } from "lucide-react";
      ...
      <header className="h-20 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            className="hidden sm:flex gap-2 bg-gradient-to-r from-[#C9A227] to-[#DEB44A] hover:from-[#B8922A] hover:to-[#CDA33D] text-white font-semibold"
          >
